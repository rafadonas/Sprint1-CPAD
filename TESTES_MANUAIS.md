...
Ambiente: Expo Web, navegador Chromium e build de produção Web  
Responsável: equipe Motiva Verde

| ID | Cenário testado | Procedimento | Resultado esperado | Resultado obtido | Status |
| --- | --- | --- | --- | --- | --- |
| CT-01 | Consultar e filtrar o mapa | Abrir o app, alternar rodovia e risco e pesquisar por KM | Exibir apenas marcadores compatíveis e atualizar a contagem | Busca e filtros atualizaram os pontos e a legenda corretamente | Passou |
