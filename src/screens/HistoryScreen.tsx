...
interface HistoryScreenProps { ocorrencias: Ocorrencia[]; onSelectOccurrence: (occurrence: Ocorrencia) => void; onNavigateToReport: () => void; }
type Filter = 'Todos' | StatusOcorrencia;
const FILTERS: Filter[] = ['Todos', 'Pendente', 'Em análise', 'Concluído'];

export const HistoryScreen = ({ ocorrencias, onSelectOccurrence, onNavigateToReport }: HistoryScreenProps) => {
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#08110C' }, header: { paddingHorizontal: 22, paddingTop: 30, paddingBottom: 15 }, subtitle: { color: '#4ADE80', fontSize: 10, fontWeight: '700', letterSpacing: 1.3 }, title: { color: '#F8FAFC', fontSize: 28, fontWeight: '800', marginTop: 3 }, summary: { color: '#94A3B8', fontSize: 13, marginTop: 4 }, quickStats: { flexDirection: 'row', gap: 9, marginTop: 13 }, quickStat: { flexDirection: 'row', alignItems: 'baseline', backgroundColor: '#111C16', borderWidth: 1, borderColor: '#294133', borderRadius: 9, paddingHorizontal: 10, paddingVertical: 7 }, quickValue: { color: '#F8FAFC', fontSize: 14, fontWeight: '800' }, quickLabel: { color: '#64748B', fontSize: 9, marginLeft: 5 }, danger: { color: '#F87171' },
  search: { marginHorizontal: 22, flexDirection: 'row', alignItems: 'center', backgroundColor: '#111C16', borderRadius: 12, paddingHorizontal: 13, borderWidth: 1, borderColor: '#294133' }, searchInput: { flex: 1, height: 46, color: '#F8FAFC', marginLeft: 8 }, filters: { paddingHorizontal: 22, paddingVertical: 13, gap: 7 }, filter: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 16, backgroundColor: '#111C16', borderWidth: 1, borderColor: '#294133' }, filterActive: { backgroundColor: '#4ADE80', borderColor: '#4ADE80' }, filterText: { color: '#CBD5E1', fontSize: 11, fontWeight: '600' }, filterTextActive: { color: '#07120A' },
