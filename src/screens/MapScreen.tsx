...
const styles = StyleSheet.create({
  ...
  noResults: { position: 'absolute', left: 20, right: 20, top: 260, backgroundColor: 'rgba(8,17,12,0.96)', borderRadius: 18, zIndex: 20 }, reportButton: { position: 'absolute', left: 20, bottom: 104, backgroundColor: '#4ADE80', borderRadius: 16, paddingHorizontal: 18, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', elevation: 4, zIndex: 10 }, reportText: { color: '#07120A', fontWeight: '800', marginLeft: 7 },
});
